...
// /// These are declared as `late` and will be initialized in `dataInit()`.
...
// late List<BitMap> FILEMAGIC; // This was `FILEMAGICS` in C++
// late List<BitMap> DIAGA8H1MASK;
// late List<BitMap> DIAGA8H1MAGIC; // This was `DIAGA8H1MAGICS` in C++
// late List<BitMap> DIAGA1H8MASK;
// late List<BitMap> DIAGA1H8MAGIC; // This was `DIAGA1H8MAGICS` in C++
